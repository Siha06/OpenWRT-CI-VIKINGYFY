...
sed -i '$a https://mirrors.pku.edu.cn/immortalwrt/snapshots/targets/qualcommax/ipq807x/kmods/6.12.55-1-938f20242d85c6c729cc6658898d7b7d/packages.adb' /etc/apk/repositories.d/distfeeds.list
